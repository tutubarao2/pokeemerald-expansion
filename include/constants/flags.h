...
#define FLAG_TEMP_5      (TEMP_FLAGS_START + 0x5)  // Reveal Flag
...
#define FLAG_UNUSED_0x264  0x264 // Unused Flag, debug trainer see toggle
#define FLAG_UNUSED_0x265  0x265 // Unused Flag, debug encounter toggle
#define FLAG_UNUSED_0x266  0x266 // Unused Flag, debug collision toggle
